...
### 锚点四：下一阶段 PRD 基准
PRD 文档：`docs/prd/mineru-local-ai-metadata-prd.md`

- 下一阶段涉及 MinerU、本地 AI 元数据、需求拆解、实现和验收，均以该 PRD 为基准
- lucode 开发前必须阅读相关 PRD 内容，并在任务报告中说明实现如何满足 PRD
- 若 PRD 与现有代码或任务单冲突，先向 lucia 提出，不得擅自改需求
